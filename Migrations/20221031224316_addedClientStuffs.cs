...
{
    public partial class addedClientStuffs : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2022, 10, 31, 18, 43, 15, 593, DateTimeKind.Local).AddTicks(7898), 1 });

            migrationBuilder.InsertData(
                table: "ClientServices",
                columns: new[] { "ID", "ClientID", "Date", "ServicesID" },
                values: new object[] { 3, 1, new DateTime(2022, 10, 31, 18, 43, 15, 600, DateTimeKind.Local).AddTicks(4344), 5 });

            migrationBuilder.InsertData(
                table: "ClientServices",
                columns: new[] { "ID", "ClientID", "Date", "ServicesID" },
                values: new object[] { 2, 2, new DateTime(2022, 10, 31, 18, 43, 15, 600, DateTimeKind.Local).AddTicks(4248), 7 });
