...
namespace RazorPages.Migrations
{
    ...
    [Migration("20221031224316_addedClientStuffs")]
    partial class addedClientStuffs
    {
            ...
            modelBuilder.Entity("RazorPages.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2022, 10, 31, 18, 43, 15, 593, DateTimeKind.Local).AddTicks(7898),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2022, 10, 31, 18, 43, 15, 600, DateTimeKind.Local).AddTicks(4248),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2022, 10, 31, 18, 43, 15, 600, DateTimeKind.Local).AddTicks(4344),
                            ServicesID = 5
                        });
                });
